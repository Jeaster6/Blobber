...
class Graphics {
	...
	public:
        ...
        SDL_Rect scaleTargetArea(const SDL_Rect);
        void renderMainMenu(const std::string&); // TODO: redo main menu to render background texture with standard UI elements, as well as settings menu being a UI element
