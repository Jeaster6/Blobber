        ...
        switch (currentEvent.button.button) {
                ...
                for (int i = firstX; i <= lastX; i++) {
                    for (int j = firstY; j <= lastY; j++) {
                        if ((i < gameMap.getWidth()) && (j < gameMap.getHeight()) && (i >=0 ) && (j >= 0)) {
                            gameMap.setTileParameters(i, j, selectedTile, selectedTile, selectedTile, selectedTile, "", "", MapObject(), MapTrigger(), false);
                            if (i - 1 >= 0 && i == firstX) {
            ...
            case SDL_BUTTON_RIGHT:
                for (int i = firstX; i <= lastX; i++) {
                    for (int j = firstY; j <= lastY; j++) {
                        if ((i < gameMap.getWidth()) && (j < gameMap.getHeight()) && (i >= 0) && (j >= 0)) {
                            gameMap.setTileParameters(i, j, "", "", "", "", selectedTile, selectedTile, MapObject(), MapTrigger(), false);
                            if (i - 1 >= 0) {
